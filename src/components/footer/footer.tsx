            ...
            <div className="w-screen flex flex-row flex-wrap justify-between bg-[#131313] py-6 sm:py-9 px-4 sm:px-16">
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <div className='flex flex-row gap-2'>
                        <Image src={logo1} style={{ width: "39px", height: "39px" }} alt=''></Image>
                        <Image src={logo2} style={{ width: "39px", height: "39px" }} alt=''></Image>
                        <Image src={logo3} style={{ width: "39px", height: "39px" }} alt=''></Image>
                        <Image src={logo4} style={{ width: "39px", height: "39px" }} alt=''></Image>
                        <Image src={logo5} style={{ width: "39px", height: "39px" }} alt=''></Image>
                        <Image src={logo6} style={{ width: "39px", height: "39px" }} alt=''></Image>
                    </div>
                </div>
            </div>
            <div className='h-px bg-[#A0A0A0]'>

            </div>
            <div className='bg-[#131313] text-center p-2'>
                <h3 className='text-[#A0A0A0]'>@2019 Fun Max Games Private Ltd. All rights reserved</h3>
            </div>
        </>
    )
}
