    ...
    <div className="w-screen flex flex-row flex-wrap justify-evenly bg-[#E9DBEC] py-6 sm:py-9 px-4 sm:px-16">
      <div className="flex py-3">
        <div style={{ marginRight: "-110px" }}>
          <Image
            src={back}
            style={{ width: "183px", height: "358px", marginTop: "33px" }}
            alt=""
          ></Image>
        </div>
        <Image
          src={front}
          style={{ width: "217px", height: "391px" }}
          alt=""
        ></Image>
      </div>
        ...
        <div className="flex flex-wrap sm:flex-nowrap gap-4 p-2 ">
          <div>
            <input
              ...
              id="email"
              placeholder="Email"
              className="rounded-xl p-1 px-4 border border-[#555]"
            />
          </div>
          <button className="bg-[#FF2C20] h-9 rounded-xl text-white text-sm px-4">
            {" "}
            Share App Link
          </button>
        </div>
