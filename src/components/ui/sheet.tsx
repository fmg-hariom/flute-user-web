...
const sheetVariants = cva(
    "fixed z-50 gap-4 bg-[#242424] p-6 shadow-lg transition ease-in-out border-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
    {
        variants: {
            side: {
