    ...
    <ScrollArea className="h-screen w-full rounded-md">
      <div className="md:px-4 sm:p-0 mt-5 ">
          ...
          skillStore.skill.list.map((menu) => (
            ...
            <React.Fragment key={menu.id}>
              <div key={menu.id} onClick={() => props.setOpen(false)}>
                <Link
                  href={`/consultant/astrologer?skill_id=${menu.id}&title=${menu.skill_name}`}
                  className="flex text-xs h-10 text-[#ECEDEF] dark:bg-background my-2 items-center justify-start p-4  dark:hover:bg-none dark:hover:text-background hover:text-white rounded-md"
                >
                  <div className="w-8 mr-2">
                    <img src={menu.icon} />
                  </div>
                  <p className="text-sm font-semibold">{menu.skill_name}</p>
                </Link>
              </div>
            </React.Fragment>
            // </SheetClose>
            ...
            <div onClick={() => props.setOpen(false)}>
              <div className="flex text-xs h-10 text-[#ECEDEF] dark:bg-background my-2 items-center p-4  dark:hover:bg-none dark:hover:text-background hover:text-white rounded-md cursor-pointer">
                ...
                <p className="text-sm font-semibold">
                  Join as{" "}
                  <span className="ml-1 text-[#FFA643]"> {" a Coach"} </span>
                </p>
              </div>
            </div>
          }
        ...
        <div onClick={() => props.setOpen(false)}>
          <Link
            href={`/magazine/list`}
            className="flex text-xs h-10 text-[#ECEDEF] dark:bg-background my-2 items-center p-4  dark:hover:bg-none dark:hover:text-background hover:text-white rounded-md"
          >
            <div className="w-8 mr-2">
              <svg
                width="24"
              ...
              >
                <path
                  d="M19.5 1.875H6.75C5.85489 1.875 4.99645 2.23058 4.36351 2.86351C3.73058 3.49645 3.375 4.35489 3.375 5.25V21C3.375 21.2984 3.49353 21.5845 3.7045 21.7955C3.91548 22.0065 4.20163 22.125 4.5 22.125H18C18.2984 22.125 18.5845 22.0065 18.7955 21.7955C19.0065 21.5845 19.125 21.2984 19.125 21C19.125 20.7016 19.0065 20.4155 18.7955 20.2045C18.5845 19.9935 18.2984 19.875 18 19.875H5.625V19.5C5.625 19.2016 5.74353 18.9155 5.9545 18.7045C6.16548 18.4935 6.45163 18.375 6.75 18.375H19.5C19.7984 18.375 20.0845 18.2565 20.2955 18.0455C20.5065 17.8345 20.625 17.5484 20.625 17.25V3C20.625 2.70163 20.5065 2.41548 20.2955 2.2045C20.0845 1.99353 19.7984 1.875 19.5 1.875ZM18.375 16.125H6.75C6.36669 16.1243 5.98613 16.1896 5.625 16.3181V5.25C5.625 4.95163 5.74353 4.66548 5.9545 4.4545C6.16548 4.24353 6.45163 4.125 6.75 4.125H18.375V16.125Z"
                  fill="#D8D8D8"
                />
              </svg>
            </div>
            <p className="text-sm font-semibold">Flute Magazine</p>
          </Link>
        </div>

        <div onClick={() => props.setOpen(false)}>
          <Link
            href={`/consultant/live`}
            className="flex text-xs h-10 text-[#ECEDEF] dark:bg-background my-2 items-center p-4  dark:hover:bg-none dark:hover:text-background hover:text-white rounded-md"
          >
            <div className="w-8 mr-2">
              <svg
            ...
            <div onClick={() => props.setOpen(true)}>
              <div className="flex text-xs h-10 text-[#ECEDEF] dark:bg-background my-2 items-center p-4  dark:hover:bg-none dark:hover:text-background hover:text-white rounded-md cursor-pointer">
                <div className="w-8 mr-2">
                  ...
                  >
                    <path
                      d="M12.4582 4.79167V10.5417H13.5794L11.4998 12.6213L9.42025 10.5417H10.5415V4.79167H12.4582ZM14.3748 2.875H8.62484V8.625H4.7915L11.4998 15.3333L18.2082 8.625H14.3748V2.875ZM18.2082 17.25H4.7915V19.1667H18.2082V17.25Z"
                      fill="white"
                    />
                  </svg>
                </div>
