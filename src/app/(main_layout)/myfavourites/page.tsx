      ...
      <div className="py-4 sm:py-8 px-2 sm:px-16 bg-black text-white">
        <div
          className={
            ...
            " flex justify-center relative flex-row items-center space-x-2 pb-3 py-2"
          }
        >
        ...
        <div className="bg-black border-t-[0.9px]  font-['Poppins'] p-6 ">
          {" "}
          <p className="text-center text-[1.34rem] tracking-wider font-normal">
            Streamline your favourites for quick access and instant connections.
          </p>
              ...
              return (
                <div className="rounded-3xl w-[15.20rem] relative h-[15.20rem] card-with-vignette">
                  ...
                  >
                    ...
                    />
                    <path
                      d="M6.75342 17.5251L17.74 6.72559"
                      stroke="black"
                      stroke-width="2.13883"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    />
                    <path
                      d="M17.74 17.5251L6.75342 6.72559"
                      stroke="black"
                      stroke-width="2.13883"
                      stroke-linecap="round"
                      stroke-linejoin="round"
