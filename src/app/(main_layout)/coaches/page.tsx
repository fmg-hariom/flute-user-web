...
export default function LiveSession() {
    const liveCards = [
        {
            image: "/images/live/unsplash_v2aKnjMbP_k.png",
            name: "Sania"
        },
        {
            image: "/images/live/unsplash_BI91NrppE38.png",
            name: "Laksh"
        },
        {
            image: "/images/live/unsplash_KIPqvvTOC1s.png",
            name: "Saurav"
        },
        {
            image: "/images/live/unsplash_2EGNqazbAMk.png",
            name: "Himanshu"
        },
        {
            image: "/images/live/unsplash_v2aKnjMbP_.png",
            name: "Sania"
        },
        {
            image: "/images/live/unsplash_BI91NrppE38.png",
        ...
        {
            image: "/images/live/unsplash_KIPqvvTOC1s (1).png",
            name: "Saurav"
        },
        {
            image: "/images/live/unsplash_2EGNqazbAMk.png",
    ...
    return (
        <>
            <div className="py-2 sm:py-3  px-2 sm:px-16 bg-black text-white">
            </div>
            ...
            <div className="py-5 sm:px-16 bg-black text-white">
                ...
                <div className="flex flex-wrap gap-14 my-6 justify-center">
                    {
                        liveCards?.map(item => {
                            return <div className="max-w-sm rounded-3xl overflow-hidden shadow-lg">
                                <div className="h-60 ">
                                    <img
                                    ...
                                    <h2 className="ml-3 relative text-2xl text-white font-bold bottom-20" style={{ marginBottom: "-45px" }}>{item?.name}</h2>
                                </div>
                                <div className="p-6 py-3 bg-white">
                                    <p className="text-black text-sm my-2">English, Hindi<br />Intimacy, Dating, Marriage</p>
