        ...
        <>
            ...
            <div className="py-5 sm:px-16 bg-black text-white">
                ...
                <div className="flex flex-wrap gap-14 my-6 justify-center mx-auto">
                    {
                        consultantProfileStore?.consultant_profile?.list?.length ? consultantProfileStore?.consultant_profile?.list?.map(item => {
                                ...
                                trigger={
                                    <div className="min-w-[300px] max-w-[300px] rounded-3xl overflow-hidden shadow-lg cursor-pointer">
                                        <div className="h-60 ">
                                            ...
                                            <h2 className="ml-3 relative text-2xl text-white font-bold bottom-20" style={{ marginBottom: "-45px" }}>{item?.first_name} {item?.last_name}</h2>
                                        </div>
