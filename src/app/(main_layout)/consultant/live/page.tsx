  ...
  return (
    <>
      <div className="w-screen flex flex-col justify-center bg-[#C9E2E5] py-8 sm:py-9 px-2 sm:px-16 text-black">
        ...
        <h6 className="text-center text-sm sm:text-lg md:text-xl w-full px-8 sm:px-1 font-bold text-[#302C28] ">
          Live Chat with the Best Astrologers, Advisors and Coaches.
        </h6>
      </div>
      <div className="py-5 sm:px-16 bg-black text-white">
        <div className="flex justify-center sm:justify-end items-center ">
          <div className="relative">
            <input
              ...
              onChange={(e) =>
                consultantProfileStore.get.paginate({ search: e.target.value })
              }
            />
            <svg
              className="absolute right-7 top-1/2 transform -translate-y-1/2 w-7 h-7 text-white"
              stroke="#ffffff"
        ...
        <div className="flex flex-wrap gap-14 my-6 justify-center mx-auto">
          {consultantProfileStore?.live_consultant_profile?.list?.length ? (
            consultantProfileStore?.live_consultant_profile?.list?.map(
              (item) => {
                return (
                  <DownloadAppDialog
                    trigger={
                      <div className="min-w-[300px] max-w-[300px] rounded-3xl overflow-hidden shadow-lg cursor-pointer">
                        <div className="h-60 ">
                          ...
                          <div className="ml-3 relative bottom-56 flex items-center justify-around bg-[#00000099] w-[74px] h-[32px] rounded-[28px]">
                            ...
                            >
                              <path
                                d="M14.9936 8.84985C14.9936 9.69879 14.6845 10.513 14.1343 11.1133C13.5841 11.7135 12.8379 12.0508 12.0598 12.0508C11.2817 12.0508 10.5355 11.7135 9.98527 11.1133C9.43507 10.513 9.12598 9.69879 9.12598 8.84985C9.12598 8.00092 9.43507 7.18675 9.98527 6.58646C10.5355 5.98617 11.2817 5.64893 12.0598 5.64893C12.8379 5.64893 13.5841 5.98617 14.1343 6.58646C14.6845 7.18675 14.9936 8.00092 14.9936 8.84985Z"
                                stroke="white"
                                stroke-width="1.25735"
                                stroke-linecap="round"
                                stroke-linejoin="round"
                              />
                              <path
                                d="M0.976562 8.84969C2.54127 4.47829 7.49878 1.38086 12.0599 1.38086C16.621 1.38086 21.5785 4.47829 23.1432 8.84969C21.5785 13.2211 16.621 16.3185 12.0599 16.3185C7.49878 16.3185 2.54127 13.2211 0.976562 8.84969Z"
                                stroke="white"
                                stroke-width="1.25735"
                                stroke-linecap="round"
                                stroke-linejoin="round"
                          ...
                          <h2
                            className="ml-3 relative text-2xl text-white font-bold bottom-20"
                        ...
                        <div className="p-6 py-3 bg-white">
                          <p className="text-black text-sm my-2 line-clamp-1">
                            {item?.languages?.join(", ")}
                          </p>
                          <p className="text-black text-sm my-2 line-clamp-1">
                          ...
                          <div className="flex justify-between pt-2  my-2">
                            <div className="flex gap-1">
                              <img
                                ...
                                alt="image"
                              />
                              <h4 className="text-black mt-0.5">
          ...
          <button
            ...
            onClick={() => {
              consultantProfileStore.get.paginate({
                page: consultantProfileStore.live_consultant_profile.page + 1,
                paginate: true,
              });
            }}
          >
