...
export default function Profile(props: any) {
    const { consultant_profile: { detail }, get } = useConsultantProfileStore();
                ...
                <div className="modal-cards">
                    <div className="container px-[10px] md:px-16  mx-auto">
                        <div className="flex flex-wrap mb-4 modal-cards p-1 lg:p-2 ">
                            <div className="rounded-md  w-full lg:w-[265px] h-[22rem]">
                                <img
                                    src={
                                        detail?.profile_photo?.url || ""
                                    }
                                        ...
                                        <div className="grow">
                                            ...
                                            <div className="mb-3">
                                                <span className="inline-block align-middle text-[14px] xl:text-[16px]">
                                                    ...
                                                    {detail?.rating_review?.avgRating}
                                                </span>
                                                ...
                                                <span className="inline-block align-middle">
                                                    Reviews: {detail?.rating_review?.totalRatings}
                                                </span>
                                            </div>
                                            <p>
                                            ...
                                            <div className="gap-2 mt-3 lg:mt-14 columns-3">
                                                    ...
                                                    <div className="bg-[#393A3F] text-center py-3 px-3 lg:py-8 lg:px-5 rounded-[24px] border-[0.31px] border-slate-500 cursor-pointer">
                                                        ...
                                                        <h2 className="lg:text-[21px] font-semibold">
                                                            <span className="inline-block me-1">
                                                                <del className="border-[#FE0000]">₹{detail?.chat_price?.current_price}</del>
                                                            </span>
                                                            <span className="text-[#33C004]">₹{detail?.chat_price?.discount_price}/min</span>
                                                        </h2>
                                                ...
                                                <DownloadAppDialog trigger={
                                                    <div className="bg-[#393A3F] text-center py-3 px-3 lg:py-8 lg:px-5 rounded-[24px] border-[0.31px] border-slate-500 cursor-pointer">
                                                        ...
                                                        <h2 className="lg:text-[21px] font-semibold">
                                                            <span className="inline-block me-1">₹{detail?.audio_call_price?.current_price} / min</span>
                                                        </h2>
                                                ...
                                                <DownloadAppDialog trigger={<div className="bg-[#393A3F] text-center py-3 px-3 lg:py-8 lg:px-5 rounded-[24px] border-[0.31px] border-slate-500 cursor-pointer">
                                                    <span className=" inline-block ">
                                                        <svg
                                                            width="46"
                                                            height="46"
                                                    ...
                                                    <h2 className="lg:text-[21px] font-semibold">
                                                        <span className="inline-block me-1">₹{detail?.video_call_price?.current_price} / min</span>
                                                    </h2>
                    ...
                    <div className="container px-[10px] md:px-16  mx-auto py-33">
                        <div className="bg-[#242424] lg:p-10 p-3 rounded-[20px]">
                            ...
                            <div className="mt-5">
                                ...
                                <p className="lg:text-[26px] text-[16px]">
                                    Greetings! I am a seasoned Astrology Expert with extensive
                                    experience and profound knowledge in the field. My expertise
                                    lies in various aspects of Astrology, offering comprehensive
                                    services to guide individuals on their life journeys. I
                                    specialize in providing insightful readings based on Vedic
                                    Astrology, helping you unravel the mysteries of your life
                                    through a meticulous analysis of your birth chart. Whether you
                                    seek guidance on career decisions, relationships, or personal
                                    development, my Astrological consultations are tailored to
                                    meet your specific needs. Additionally, my proficiency extends
                                    to Vastu, where I assist in creating harmonious environments
                                    for positive energies to flourish. Clients appreciate my
                                    practical approach, as I combine ancient wisdom with
                                    contemporary insights to address modern challenges.
                                </p>
                            </div>
                            <div className="mt-5">
                                <h2 className="lg:text-[36px] text-[22px] text-[#D9D9D9]">
                                ...
                                <p className="lg:text-[26px] text-[16px]">
                                    I am proud to have acquired my Jyotish Shiksha from the
                                    esteemed city of Banaras, deepening my understanding of Vedic
                                    Astrology. With several years of hands-on experience, I have
                                    honed my skills to become a trusted advisor in the realms of
                                    career, job, and relationship Astrology. My journey includes
                                    successfully navigating through diverse birth charts, offering
                                    valuable insights that have guided individuals towards
                                    fulfilling their potential. My commitment to continuous
                                    learning ensures that my clients receive the most accurate and
                                    up-to-date Astrological advice. Being a proficient Vastu
                                    consultant, my expertise extends beyond Astrological
                                    predictions, allowing me to contribute significantly to
                                    creating balanced and harmonious living and working spaces.
                                    Trust me to be your dedicated Astrology Expert, providing you
                                    with the guidance needed to navigate the complexities of life
