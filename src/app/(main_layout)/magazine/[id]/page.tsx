...

        {
          store.magazine?.detail ?
            ...
            <div className="container mx-auto px-8">
              ...
              <div>
                <h2 className="text-2xl md:text-5xl font-bold mt-7 mb-2 leading-tight	">
                ...
                } className="mb-4 magazine-sub-title" />
              </div>
              ...
              <div className="mt-5 bg-[#242424] p-[20px]  rounded-lg shadow-insets">
                ...
                <div className="flex justify-between items-center flex-col md:flex-row">
                  <div className="flex items-center w-full justify-between md:justify-normal  md:w-auto mb-4 md:mb-0">
                    ...
                    <img
                      src={store.magazine.detail?.author_image || "https://placehold.co/200x200"}
                      className="rounded-[100%] w-[50px] h-[50px] md:w-[80px] md:h-[80px] border-4 border-white border-solid md:mr-2"
                      alt=""
                    />
                    {/* </div> */}
                    <div>
                      <span className="text-[#D9D9D9] font-bold text-[15px] md:text-[16px]">Written by</span>
                  ...
                  <span className="inline-block align-middle opacity-50">
                    ...
                    <div className="px-0 md:px-8 flex flex-row sm:flex-col items-center justify-center">
