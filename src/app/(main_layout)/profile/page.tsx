            ...
            <div className="flex flex-wrap mb-4 modal-cards p-1 lg:p-2 ">
              <div className="flex-none grow">
                <img
                  ...
                  className=" rounded-md h-full w-full lg:w-[265px]  object-center object-cover"
                  width={"100%"}
                  alt="..."
                />
              </div>
                  ...
                  <div className="flex flex-wrap  justify-between">
                    ...
                    <div className="grow  md:ps-4">
                      ...
                      <div className="gap-2 mt-3 lg:mt-14 columns-3">
                        <div className="bg-[#393A3F] text-center py-3 px-3 lg:py-8 lg:px-5 rounded-[24px] border-[0.31px] border-slate-500">
                          ...
                          <h2 className="lg:text-[21px] font-semibold">
                            <span className="inline-block me-1">
                              <del className="border-[#FE0000]">₹4</del>
                            </span>
                            <span className="text-[#33C004]">₹3/min</span>
                          </h2>
                        ...
                        <div className="bg-[#393A3F] text-center py-3 px-3 lg:py-8 lg:px-5 rounded-[24px] border-[0.31px] border-slate-500">
                          ...
                          <h2 className="lg:text-[21px] font-semibold">
                            <span className="inline-block me-1">₹8 / min</span>
                          </h2>
                        ...
                        <div className="bg-[#393A3F] text-center py-3 px-3 lg:py-8 lg:px-5 rounded-[24px] border-[0.31px] border-slate-500">
                          ...
                          <h2 className="lg:text-[21px] font-semibold">
                            <span className="inline-block me-1">₹16/min</span>
                          </h2>
